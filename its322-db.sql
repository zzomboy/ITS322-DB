...
(6, 3, 'What Is Global Warming? 6', 'National GeoGraphic', '2017-12-04 12:31:17', 'Glaciers are melting, sea levels are rising, cloud forests are dying, and wildlife is scrambling to keep pace. It\'s becoming clear that humans have caused most of the past century\'s warming by releasing heat-trapping gases as we power our modern lives. Called greenhouse gases, their levels are higher now than in the last 650,000 years.\r\nWe call the result global warming, but it is causing a set of changes to the Earth\'s climate, or long-term weather patterns, that varies from place to place. As the Earth spins each day, the new heat swirls with it, picking up moisture over the oceans, rising here, settling there. It\'s changing the rhythms of climate that all living things have come to rely upon.\r\nWhat will we do to slow this warming? How will we cope with the changes we\'ve already set into motion? While we struggle to figure it all out, the face of the Earth as we know it—coasts, forests, farms and snow-capped mountains—hangs in the balance.\r\nGreenhouse effect\r\nThe \"greenhouse effect\" is the warming that happens when certain gases in Earth\'s atmosphere trap heat. These gases let in light but keep heat from escaping, like the glass walls of a greenhouse.\r\nFirst, sunlight shines onto the Earth\'s surface, where it is absorbed and then radiates back into the atmosphere as heat. In the atmosphere, “greenhouse” gases trap some of this heat, and the rest escapes into space. The more greenhouse gases are in the atmosphere, the more heat gets trapped.', 'img_mountains.jpg?#img_lights.jpg', 0),
(7, 2, 'What Is Global Warming? 7', 'National GeoGraphic', '2017-12-04 13:50:27', 'Glaciers are melting, sea levels are rising, cloud forests are dying, and wildlife is scrambling to keep pace. It\'s becoming clear that humans have caused most of the past century\'s warming by releasing heat-trapping gases as we power our modern lives. Called greenhouse gases, their levels are higher now than in the last 650,000 years.\r\nWe call the result global warming, but it is causing a set of changes to the Earth\'s climate, or long-term weather patterns, that varies from place to place. As the Earth spins each day, the new heat swirls with it, picking up moisture over the oceans, rising here, settling there. It\'s changing the rhythms of climate that all living things have come to rely upon.\r\nWhat will we do to slow this warming? How will we cope with the changes we\'ve already set into motion? While we struggle to figure it all out, the face of the Earth as we know it—coasts, forests, farms and snow-capped mountains—hangs in the balance.\r\nGreenhouse effect\r\nThe \"greenhouse effect\" is the warming that happens when certain gases in Earth\'s atmosphere trap heat. These gases let in light but keep heat from escaping, like the glass walls of a greenhouse.\r\nFirst, sunlight shines onto the Earth\'s surface, where it is absorbed and then radiates back into the atmosphere as heat. In the atmosphere, “greenhouse” gases trap some of this heat, and the rest escapes into space. The more greenhouse gases are in the atmosphere, the more heat gets trapped.', 'img_lights.jpg?#img_mountains.jpg', 0),
(8, 1, 'What Is Global Warming? 8', 'National GeoGraphic', '2017-12-04 14:09:22', 'Glaciers are melting, sea levels are rising, cloud forests are dying, and wildlife is scrambling to keep pace. It\'s becoming clear that humans have caused most of the past century\'s warming by releasing heat-trapping gases as we power our modern lives. Called greenhouse gases, their levels are higher now than in the last 650,000 years.\r\nWe call the result global warming, but it is causing a set of changes to the Earth\'s climate, or long-term weather patterns, that varies from place to place. As the Earth spins each day, the new heat swirls with it, picking up moisture over the oceans, rising here, settling there. It\'s changing the rhythms of climate that all living things have come to rely upon.\r\nWhat will we do to slow this warming? How will we cope with the changes we\'ve already set into motion? While we struggle to figure it all out, the face of the Earth as we know it—coasts, forests, farms and snow-capped mountains—hangs in the balance.\r\nGreenhouse effect\r\nThe \"greenhouse effect\" is the warming that happens when certain gases in Earth\'s atmosphere trap heat. These gases let in light but keep heat from escaping, like the glass walls of a greenhouse.\r\nFirst, sunlight shines onto the Earth\'s surface, where it is absorbed and then radiates back into the atmosphere as heat. In the atmosphere, “greenhouse” gases trap some of this heat, and the rest escapes into space. The more greenhouse gases are in the atmosphere, the more heat gets trapped.', 'img_mountains.jpg?#img_lights.jpg', 2),
(10, 3, 'What Is Global Warming? 9', 'National GeoGraphic', '2017-12-04 14:49:23', 'Glaciers are melting, sea levels are rising, cloud forests are dying, and wildlife is scrambling to keep pace. It\'s becoming clear that humans have caused most of the past century\'s warming by releasing heat-trapping gases as we power our modern lives. Called greenhouse gases, their levels are higher now than in the last 650,000 years.\r\nWe call the result global warming, but it is causing a set of changes to the Earth\'s climate, or long-term weather patterns, that varies from place to place. As the Earth spins each day, the new heat swirls with it, picking up moisture over the oceans, rising here, settling there. It\'s changing the rhythms of climate that all living things have come to rely upon.\r\nWhat will we do to slow this warming? How will we cope with the changes we\'ve already set into motion? While we struggle to figure it all out, the face of the Earth as we know it\'s coasts, forests, farms and snow-capped mountains\'s hangs in the balance.\r\nGreenhouse effect\r\nThe \"greenhouse effect\" is the warming that happens when certain gases in Earth\'s atmosphere trap heat. These gases let in light but keep heat from escaping, like the glass walls of a greenhouse.\r\nFirst, sunlight shines onto the Earth\'s surface, where it is absorbed and then radiates back into the atmosphere as heat. In the atmosphere, \"greenhouse\" gases trap some of this heat, and the rest escapes into space. The more greenhouse gases are in the atmosphere, the more heat gets trapped.', 'img_mountains.jpg?#img_lights.jpg', 68);

--
-- Triggers `article`
--
DELIMITER $$
CREATE TRIGGER `change_tag` BEFORE UPDATE ON `article` FOR EACH ROW BEGIN
	IF new.tag_id != old.tag_id
    	THEN UPDATE  tags SET visitor_count = visitor_count + new.visitor_art where tag_id = new.tag_id;
		UPDATE  tags SET visitor_count = visitor_count - new.visitor_art where tag_id = old.tag_id;
    END IF;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `plus1_tagcount` AFTER UPDATE ON `article` FOR EACH ROW BEGIN
	IF new.visitor_art > old.visitor_art
    	THEN UPDATE tags SET visitor_count = visitor_count + 1 WHERE tag_id = new.tag_id;
    END IF;
END
$$
DELIMITER ;
...
(3, 'test 00', 'test00@email.com'),
(7, 'test 01', 'test01@email.com');
...
--
ALTER TABLE `tags`
  MODIFY `tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;COMMIT;
